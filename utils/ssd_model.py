...
class Detect(Function): #+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++ for  new  torch version 2024/5/4 By ChatGPT
    ...
    def forward(self, loc_data, conf_data, dbox_list):
        ...
        # Softmaxを適用する際にdimパラメータを指定
        conf_data = torch.softmax(conf_data, dim=-1)

        #output = torch.zeros(num_batch, num_classes, self.top_k, 5)
        output = torch.zeros(num_batch, num_classes, 200, 5) #+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++ for  new  torch version 2024/5/4
        # confデータの転置
        ...
        for i in range(num_batch):
            ...
            for cl in range(1, num_classes):
                c_mask = conf_scores[cl].gt(0.01) #+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++ for  new  torch version 2024/5/4
                ...
                boxes = decoded_boxes[l_mask].reshape(-1, 4)  # viewからreshapeへ変更

                # Non-Maximum Suppressionの更新
                #ids = torchvision.ops.nms(boxes, scores, self.nms_thresh)  # 更新されたNMSの呼び出し
                ids = torchvision.ops.nms(boxes, scores, 0.45)  # #+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++ for  new  torch version 2024/5/4
                count = ids.size(0)
...
class SSD(nn.Module):
    ...
    def forward(self, x):
        ...
        if self.phase == "inference":  # 推論時
            with torch.no_grad(): #+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++ for  new  torch version 2024/5/4
